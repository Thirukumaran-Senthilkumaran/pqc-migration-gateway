...
class ConnectorToken(Base):
    ...
    devices: Mapped[list["LanDevice"]] = relationship(back_populates="token")
    heartbeats: Mapped[list["ConnectorHeartbeat"]] = relationship(back_populates="token")
...
class ConnectorHeartbeat(Base):
    ...
    connector_version: Mapped[str] = mapped_column(String(16), default="1.0")
